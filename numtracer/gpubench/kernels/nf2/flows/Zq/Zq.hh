...
namespace DiFfRG { template<typename> class Zq_kernel;

  class Zq_integrator
  {
    public:
    Zq_integrator(DiFfRG::QuadratureProvider& quadrature_provider, const DiFfRG::ConfigTree& config)
    ;


    using Regulator = DiFfRG::PolynomialExpRegulator<>;

    Integrator_p2_1ang<4, double, Zq_kernel<Regulator>, DiFfRG::GPU_exec> integrator;
