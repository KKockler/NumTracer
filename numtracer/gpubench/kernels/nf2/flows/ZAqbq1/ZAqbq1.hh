...
namespace DiFfRG { template<typename> class ZAqbq1_kernel;

  class ZAqbq1_integrator
  {
    public:
    ZAqbq1_integrator(DiFfRG::QuadratureProvider& quadrature_provider, const DiFfRG::ConfigTree& config)
    ;


    using Regulator = DiFfRG::PolynomialExpRegulator<>;

    Integrator_p2_4D_2ang<4, double, ZAqbq1_kernel<Regulator>, DiFfRG::GPU_exec> integrator;
...
using DiFfRG::ZAqbq1_integrator;