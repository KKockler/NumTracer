...
namespace DiFfRG { template<typename> class ZAqbq7_kernel;

  class ZAqbq7_integrator
  {
    public:
    ZAqbq7_integrator(DiFfRG::QuadratureProvider& quadrature_provider, const DiFfRG::ConfigTree& config)
    ;


    using Regulator = DiFfRG::PolynomialExpRegulator<>;

    Integrator_p2_4D_2ang<4, double, ZAqbq7_kernel<Regulator>, DiFfRG::GPU_exec> integrator;
...
using DiFfRG::ZAqbq7_integrator;