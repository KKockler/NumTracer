...
namespace DiFfRG { template<typename> class ZAqbq4_kernel;

  class ZAqbq4_integrator
  {
    public:
    ZAqbq4_integrator(DiFfRG::QuadratureProvider& quadrature_provider, const DiFfRG::ConfigTree& config)
    ;


    using Regulator = DiFfRG::PolynomialExpRegulator<>;

    Integrator_p2_4D_2ang<4, double, ZAqbq4_kernel<Regulator>, DiFfRG::GPU_exec> integrator;
...
using DiFfRG::ZAqbq4_integrator;