...
namespace DiFfRG { template<typename> class ZAAqbq2_kernel;

  class ZAAqbq2_integrator
  {
    public:
    ZAAqbq2_integrator(DiFfRG::QuadratureProvider& quadrature_provider, const DiFfRG::ConfigTree& config)
    ;


    using Regulator = DiFfRG::PolynomialExpRegulator<>;

    Integrator_p2_4D_3ang<4, double, ZAAqbq2_kernel<Regulator>, DiFfRG::GPU_exec> integrator;
...
using DiFfRG::ZAAqbq2_integrator;