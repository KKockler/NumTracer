...
int main()
{
  ...
  for (const Pt &t : pts) {
    ...
    check("tr(g^0 q1)", numtracer_kernels::Fixc_t_kernel::kernel(a[0], a[1], a[2], a[3], a[4]),
          4.0 * t.p0);
    check("tr(g^1 q1)", numtracer_kernels::Fixc_x_kernel::kernel(a[0], a[1], a[2], a[3], a[4]),
          4.0 * t.p);
    ...
    check("tr(g^0 g^0)", numtracer_kernels::Fixc_tt_kernel::kernel(a[0], a[1], a[2], a[3], a[4]),
          4.0);
    ...
    const double got4 = numtracer_kernels::Fixc_4_kernel::kernel(a[0], a[1], a[2], a[3], a[4]);
    ...
    const double gotRef =
        numtracer_kernels::Fixc_4ref_kernel::kernel(a[0], a[1], a[2], a[3], a[4]);
    ...
    check("g^{0v} q1_v tr(g^0 ql)",
          numtracer_kernels::Fixc_g_kernel::kernel(a[0], a[1], a[2], a[3], a[4]),
          4.0 * t.l0 * t.p0);
  }
