...
namespace DiFfRG {
  ...
  class EtaPiL_form_kernel
  {
    ...
    // clang-format on
    {
      ...
      return -9.e6 * _den1 * _den2 * fma(-1., _interp1 * _interp2, fma(-1., _interp3 * (-50. * _interp2 + _interp4 + 50. * _interp5), 0.)) * fma(0.001, _cse10 * _cse7 * powr<2>(_interp11) * powr<4>(_interp6) * cos1 * powr<2>(rhoL), fma(-2., _cse6 * powr<2>(_interp12) * (powr<2>(_cse6) + 0.5 * powr<2>(_interp6) * rhoL) * (2. * _cse2 * powr<2>(_interp10) + 4. * _cse3 * _interp10 * _interp2 * _interp9 + 2. * powr<2>(_interp2) * powr<2>(_interp9) + powr<2>(_interp8) * rhoL), fma(_cse7, powr<2>(_interp11) * (4. * _cse10 * powr<4>(_cse6) * l1 + powr<3>(_interp6) * (2. * _cse3 * _cse6 * _interp8 - _cse10 * _interp6 * l1) * powr<2>(rhoL) + 4. * powr<3>(_cse6) * (-0.001 * _cse10 * _cse6 * cos1 + _cse3 * _interp6 * _interp8 * rhoL)), 0.)));
    }
