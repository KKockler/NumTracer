...
static inline auto probe_full(const double& l1, const double& cos1, const double& cos2, const double& p, const double& k)
{
  ...
  const double dr_1 = -sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p - 2. * cosl1p2 * l1 * p + powr<2>(p))) * ntStub(80376., 1. * powr<2>(k) + 1.618033988749895 * (powr<2>(l1) - 2. * cosl1p1 * l1 * p - 2. * cosl1p2 * l1 * p + powr<2>(p))) * ntStub(85453., 1. * k) - ntStub(85453., 1. * sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p - 2. * cosl1p2 * l1 * p + powr<2>(p)));
  const double dr_2 = ntStub(30415., 1. * sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)));
  const double dr_3 = -sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) * ntStub(80376., 1. * powr<2>(k) + 1.618033988749895 * (powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) * ntStub(85453., 1. * k) - ntStub(85453., 1. * sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)));
...
static inline auto probe_proj(const double& l1, const double& cos1, const double& cos2, const double& p, const double& k)
{
  ...
  const double dr_5 = -powr<-1>(l1) * ntStub(80376., 1. * powr<2>(k) + 1.618033988749895 * powr<2>(l1)) * ntStub(85453., 1. * k) - ntStub(85453., 1. * l1);
  DiFfRG::za3_num::fill(fenv, l1, cos1, cos2, p, dr_0, dr_1, dr_2, dr_3, dr_4, dr_5);
  const auto _interp1 = ntStub(13076., 0.5 * sqrt(2. * powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + 3. * powr<2>(p)));
  const auto _interp2 = ntStub(62323., 0.816496580927726 * sqrt(powr<2>(l1) - (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
  ...
  const auto _interp9 = ntStub(29441., 1. * sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
  const auto _interp10 = ntStub(89189., 1. * powr<2>(k) + 1.618033988749895 * (powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
  const auto _interp11 = ntStub(62323., 0.816496580927726 * sqrt(powr<2>(l1) - cosl1p1 * l1 * p + powr<2>(p)));
  const auto _interp12 = ntStub(62323., 0.5773502691896258 * sqrt(2. * powr<2>(l1) - 2. * (2. * cosl1p1 + cosl1p2) * l1 * p + 3. * powr<2>(p)));
  ...
  const auto _interp15 = ntStub(27736., 0.816496580927726 * sqrt(powr<2>(l1) - cosl1p1 * l1 * p + powr<2>(p)));
  const auto _interp16 = ntStub(27736., 0.816496580927726 * sqrt(powr<2>(l1) - (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
  const auto _interp17 = ntStub(27736., 0.5773502691896258 * sqrt(2. * powr<2>(l1) - 2. * (2. * cosl1p1 + cosl1p2) * l1 * p + 3. * powr<2>(p)));
  const auto _interp18 = ntStub(20621., 1. * l1);
  const auto _interp19 = ntStub(20621., 1. * k);
  const auto _interp20 = ntStub(20621., 1. * sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)));
  const auto _interp21 = ntStub(20621., 1. * sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
  const auto _interp22 = ntStub(20621., 1.02 * k);
  const auto _interp23 = ntStub(95661., 1. * k);
  const auto _den1 = powr<-1>(1. + powr<6>(k));
  const auto _den2 = powr<-2>(_interp4 * _interp5 + _interp3 * powr<2>(l1));
  const auto _den3 = powr<-2>(_interp19 * _interp5 + _interp18 * powr<2>(l1));
  const auto _den4 = powr<-1>(_interp14 * _interp4 + _interp13 * (powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)));
  const auto _den5 = -powr<-1>(_interp14 * _interp19 + _interp20 * (powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)));
  const auto _den6 = powr<-1>(_interp10 * _interp4 + _interp9 * (powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
  const auto _den7 = -powr<-1>(_interp10 * _interp19 + _interp21 * (powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
  ...
  return fma(-0.005050505050505051, _cse1 * _cse8 * _den2 * _den6 * DiFfRG::za3_num::tr1(fenv) * _interp1 * _interp2, fma(-0.005050505050505051, _cse1 * _cse8 * _den2 * _den4 * _den6 * DiFfRG::za3_num::tr0(fenv) * _interp11 * _interp12 * _interp2, fma(-0.0101010101010101, _cse1 * _den3 * _den5 * _den7 * DiFfRG::za3_num::tr2(fenv) * _interp15 * _interp16 * _interp17 * ((50. * (-_interp19 + _interp22) + _interp23) * _interp5 + _interp19 * _interp6), 0.)));
}
