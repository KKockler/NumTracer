...
#include "EMVert_off_kernels.hh"

namespace numtracer_kernels
{
  class EMVert_off_kernel
  {
    public:
    static inline auto kernel(const double& p01, const double& p02, const double& p03, const double& p, const double& f0, const double& l1, const double& cos1, const double& phi)
    {
      ...
      double fenv[(numtracer_kernels::emvert_off::nenv) > 0 ? (numtracer_kernels::emvert_off::nenv) : 1];
      numtracer_kernels::emvert_off::fill(fenv, p01, p02, p03, p, f0, l1, cos1, phi);
      return numtracer_kernels::emvert_off::tr0(fenv);
    }
...
using numtracer_kernels::EMVert_off_kernel;