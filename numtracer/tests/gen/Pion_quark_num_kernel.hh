...
namespace numtracer_kernels
{
  class Pion_quark_num_kernel
  {
    ...
    static inline auto kernel(const double& l1, const double& cos1, const double& p, const double& k)
    {
      ...
      double fenv[(numtracer_kernels::pion_quark_num::nenv) > 0 ? (numtracer_kernels::pion_quark_num::nenv) : 1];
      ...
      return 0.3333333333333333 * fma(-1., _den1 * _den2 * _interp3 * numtracer_kernels::pion_quark_num::tr0(fenv), fma(_den1, _den2 * _interp3 * numtracer_kernels::pion_quark_num::tr1(fenv), 0.));
    }
