...
namespace numtracer_kernels
{
  class Epsstraddle_num_kernel
  {
    ...
    static inline auto kernel(const double& l1, const double& cos1, const double& cos2, const double& p)
    {
      ...
      numtracer_kernels::epsstraddle_num::fill(fenv, l1, cos1, cos2, p);
      return fma(2., numtracer_kernels::epsstraddle_num::tr0(fenv), fma(-2., numtracer_kernels::epsstraddle_num::tr1(fenv), fma(3., numtracer_kernels::epsstraddle_num::tr2(fenv), fma(-3., numtracer_kernels::epsstraddle_num::tr3(fenv), 0.))));
    }
