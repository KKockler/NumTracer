...
static inline auto probe_proj(const double& l1, const double& cos1, const double& cos2, const double& phi, const double& p, const double& k)
{
  ...
  return -0.0003662109375 * fma(_cse1, _cse8 * _den2 * _den5 * DiFfRG::zaaqbq1_small_num::tr2(fenv) * _interp1 * _interp10, fma(2., _cse1 * _cse8 * _den2 * _den3 * _den5 * DiFfRG::zaaqbq1_small_num::tr1(fenv) * _interp10 * _interp11 * _interp12, fma(_cse1, _cse8 * _den2 * _den3 * _den4 * DiFfRG::zaaqbq1_small_num::tr0(fenv) * _interp11 * _interp15 * _interp18, 0.)));
}
