...
#include "Fixc_4ref_kernels.hh"

namespace numtracer_kernels
{
  template<typename REG>
  class Fixc_4ref_kernel
  {
    public:
    static inline auto kernel(const double& p0, const double& p, const double& l0, const double& l1, const double& cos1)
    {
      ...
      double fenv[(numtracer_kernels::fixc_4ref::nenv) > 0 ? (numtracer_kernels::fixc_4ref::nenv) : 1];
      numtracer_kernels::fixc_4ref::fill(fenv, p0, p, l0, l1, cos1);  return numtracer_kernels::fixc_4ref::tr0(fenv);
    }
...
using numtracer_kernels::Fixc_4ref_kernel;