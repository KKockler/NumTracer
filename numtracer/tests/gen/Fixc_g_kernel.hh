...
namespace numtracer_kernels
{
  ...
  class Fixc_g_kernel
  {
    ...
    static inline auto kernel(const double& p0, const double& p, const double& l0, const double& l1, const double& cos1)
    {
      ...
      double fenv[(numtracer_kernels::fixc_g::nenv) > 0 ? (numtracer_kernels::fixc_g::nenv) : 1];
      numtracer_kernels::fixc_g::fill(fenv, p0, p, l0, l1, cos1);  return numtracer_kernels::fixc_g::tr0(fenv) * numtracer_kernels::fixc_g::tr1(fenv) * numtracer_kernels::fixc_g::tr2(fenv);
    }
...
using numtracer_kernels::Fixc_g_kernel;