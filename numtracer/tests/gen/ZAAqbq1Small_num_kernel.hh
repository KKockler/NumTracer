...
namespace DiFfRG
{
  class ZAAqbq1Small_num_kernel
  {
    ...
    // clang-format on
    {
      ...
      DiFfRG::zaaqbq1_small_num::fill(fenv, l1, cos1, cos2, phi, p);
      ...
      return -0.0003662109375 * fma(_cse1, _cse8 * _den2 * _den4 * _den6 * DiFfRG::zaaqbq1_small_num::tr1(fenv) * _interp11 * _interp12 * _interp13, fma(_cse1, _cse8 * _den2 * _den3 * _den6 * DiFfRG::zaaqbq1_small_num::tr2(fenv) * _interp13 * _interp16 * _interp17, fma(_cse1, _cse8 * _den2 * _den6 * DiFfRG::zaaqbq1_small_num::tr3(fenv) * _interp13 * _interp18, fma(_cse1, _cse8 * _den2 * _den3 * _den5 * DiFfRG::zaaqbq1_small_num::tr0(fenv) * _interp16 * _interp21 * _interp22, 0.))));
    }
