...
namespace DiFfRG
{
  class ZA4_num_kernel
  {
    ...
    // clang-format on
    {
      ...
      DiFfRG::za4_num::fill(fenv, l1, cos1, cos2, phi, p, dr_0, dr_1, dr_2, dr_3, dr_4, dr_5, dr_6, dr_7, dr_8, dr_9, dr_10, dr_11, dr_12, dr_13, dr_14, dr_15, dr_16, dr_17, dr_18, dr_19, dr_20, dr_21, dr_22, dr_23);
      ...
      const auto _interp118 = ntRe(DiFfRG::za4_num::tr35(fenv));
      const auto _interp119 = ntRe(DiFfRG::za4_num::tr36(fenv));
      const auto _interp120 = ntRe(DiFfRG::za4_num::tr37(fenv));
      ...
      const auto _interp126 = ntRe(DiFfRG::za4_num::tr38(fenv));
      const auto _interp130 = ntRe(DiFfRG::za4_num::tr51(fenv));
      const auto _interp132 = ZAcbc(0.3333333333333333 * sqrt(6. * powr<2>(l1) - 6. * (cosl1p1 + 2. * cosl1p3) * l1 * p + 10. * powr<2>(p)));
      const auto _interp134 = ntRe(DiFfRG::za4_num::tr52(fenv));
      const auto _interp135 = ntRe(DiFfRG::za4_num::tr53(fenv));
      const auto _interp137 = ZAcbc(0.3333333333333333 * sqrt(6. * powr<2>(l1) - 6. * (2. * cosl1p2 + cosl1p3) * l1 * p + 10. * powr<2>(p)));
      const auto _interp139 = ntRe(DiFfRG::za4_num::tr54(fenv));
      const auto _interp140 = ntRe(DiFfRG::za4_num::tr55(fenv));
      const auto _interp143 = ntRe(DiFfRG::za4_num::tr39(fenv));
      ...
      const auto _interp147 = ntRe(DiFfRG::za4_num::tr40(fenv));
      const auto _interp148 = ntRe(DiFfRG::za4_num::tr41(fenv));
      ...
      const auto _interp152 = ntRe(DiFfRG::za4_num::tr42(fenv));
      const auto _interp153 = ntRe(DiFfRG::za4_num::tr43(fenv));
      const auto _interp154 = ZAcbc(0.3333333333333333 * sqrt(6. * powr<2>(l1) + 6. * (cosl1p2 + 2. * cosl1p3) * l1 * p + 10. * powr<2>(p)));
      const auto _interp155 = ntRe(DiFfRG::za4_num::tr44(fenv));
      ...
      const auto _interp1 = ntRe(DiFfRG::za4_num::tr10(fenv));
      const auto _interp18 = ntRe(DiFfRG::za4_num::tr8(fenv));
      const auto _interp23 = ntRe(DiFfRG::za4_num::tr9(fenv));
      const auto _interp28 = ntRe(DiFfRG::za4_num::tr11(fenv));
      const auto _interp33 = ntRe(DiFfRG::za4_num::tr6(fenv));
      const auto _interp38 = ntRe(DiFfRG::za4_num::tr7(fenv));
      const auto _interp95 = ntRe(DiFfRG::za4_num::tr45(fenv));
      ...
      const auto _interp107 = ntRe(DiFfRG::za4_num::tr46(fenv));
      const auto _interp108 = ntRe(DiFfRG::za4_num::tr47(fenv));
      const auto _interp112 = ntRe(DiFfRG::za4_num::tr48(fenv));
      const auto _interp113 = ntRe(DiFfRG::za4_num::tr33(fenv));
      const auto _interp117 = ntRe(DiFfRG::za4_num::tr34(fenv));
      const auto _interp127 = ntRe(DiFfRG::za4_num::tr49(fenv));
      const auto _interp129 = ntRe(DiFfRG::za4_num::tr50(fenv));
      const auto _interp142 = ntRe(DiFfRG::za4_num::tr56(fenv));
      const auto _interp40 = ntRe(DiFfRG::za4_num::tr2(fenv));
      const auto _interp44 = ZA3(0.3333333333333333 * sqrt(6. * powr<2>(l1) - 6. * (cosl1p1 - cosl1p2 + cosl1p3) * l1 * p + 10. * powr<2>(p)));
      const auto _interp45 = ntRe(DiFfRG::za4_num::tr0(fenv));
      const auto _interp49 = ZA3(0.3333333333333333 * sqrt(6. * powr<2>(l1) - 6. * (cosl1p1 + cosl1p2 - cosl1p3) * l1 * p + 10. * powr<2>(p)));
      const auto _interp50 = ntRe(DiFfRG::za4_num::tr1(fenv));
      const auto _interp51 = ntRe(DiFfRG::za4_num::tr4(fenv));
      const auto _interp55 = ZA3(0.3333333333333333 * sqrt(6. * powr<2>(l1) + 6. * (2. * cosl1p2 + cosl1p3) * l1 * p + 10. * powr<2>(p)));
      const auto _interp56 = ntRe(DiFfRG::za4_num::tr3(fenv));
      const auto _interp60 = ZA3(0.3333333333333333 * sqrt(6. * powr<2>(l1) + 6. * (cosl1p1 + 2. * cosl1p3) * l1 * p + 10. * powr<2>(p)));
      const auto _interp61 = ntRe(DiFfRG::za4_num::tr5(fenv));
      const auto _interp62 = ZA3(0.3333333333333333 * sqrt(6. * powr<2>(l1) + 6. * (cosl1p2 + 2. * cosl1p3) * l1 * p + 10. * powr<2>(p)));
      const auto _interp63 = ntRe(DiFfRG::za4_num::tr24(fenv));
      const auto _interp64 = ZA4(0.408248290463863 * sqrt(3. * powr<2>(l1) - 3. * (cosl1p1 + cosl1p2) * l1 * p + 5. * powr<2>(p)));
      const auto _interp65 = ntRe(DiFfRG::za4_num::tr25(fenv));
      const auto _interp66 = ntRe(DiFfRG::za4_num::tr13(fenv));
      const auto _interp67 = ntRe(DiFfRG::za4_num::tr12(fenv));
      const auto _interp68 = ntRe(DiFfRG::za4_num::tr26(fenv));
      const auto _interp69 = ntRe(DiFfRG::za4_num::tr27(fenv));
      const auto _interp70 = ZA4(0.408248290463863 * sqrt(3. * powr<2>(l1) - 3. * (cosl1p1 + cosl1p3) * l1 * p + 5. * powr<2>(p)));
      const auto _interp71 = ntRe(DiFfRG::za4_num::tr14(fenv));
      const auto _interp72 = ntRe(DiFfRG::za4_num::tr28(fenv));
      const auto _interp73 = ntRe(DiFfRG::za4_num::tr29(fenv));
      const auto _interp74 = ntRe(DiFfRG::za4_num::tr16(fenv));
      const auto _interp75 = ZA4(0.408248290463863 * sqrt(3. * powr<2>(l1) - 3. * (cosl1p2 + cosl1p3) * l1 * p + 5. * powr<2>(p)));
      const auto _interp76 = ntRe(DiFfRG::za4_num::tr30(fenv));
      const auto _interp77 = ntRe(DiFfRG::za4_num::tr31(fenv));
      const auto _interp78 = ntRe(DiFfRG::za4_num::tr32(fenv));
      const auto _interp79 = ntRe(DiFfRG::za4_num::tr15(fenv));
      const auto _interp80 = ZA4(0.408248290463863 * sqrt(3. * powr<2>(l1) + 3. * (cosl1p1 + cosl1p3) * l1 * p + 5. * powr<2>(p)));
      const auto _interp81 = ntRe(DiFfRG::za4_num::tr17(fenv));
      const auto _interp82 = ZA4(0.408248290463863 * sqrt(3. * powr<2>(l1) + 3. * (cosl1p2 + cosl1p3) * l1 * p + 5. * powr<2>(p)));
      const auto _interp83 = ntRe(DiFfRG::za4_num::tr18(fenv));
      const auto _interp84 = ZA4(0.7071067811865475 * sqrt(powr<2>(l1) + (-cosl1p1 + cosl1p2) * l1 * p + 2. * powr<2>(p)));
      const auto _interp85 = ntRe(DiFfRG::za4_num::tr19(fenv));
      const auto _interp86 = ZA4(0.7071067811865475 * sqrt(powr<2>(l1) - (cosl1p1 + cosl1p2 + 2. * cosl1p3) * l1 * p + 2. * powr<2>(p)));
      const auto _interp87 = ntRe(DiFfRG::za4_num::tr20(fenv));
      const auto _interp88 = ZA4(0.7071067811865475 * sqrt(powr<2>(l1) - (cosl1p1 + 2. * cosl1p2 + cosl1p3) * l1 * p + 2. * powr<2>(p)));
      const auto _interp89 = ntRe(DiFfRG::za4_num::tr21(fenv));
      const auto _interp90 = ZA4(0.7071067811865475 * sqrt(powr<2>(l1) - (2. * cosl1p1 + cosl1p2 + cosl1p3) * l1 * p + 2. * powr<2>(p)));
      const auto _interp91 = ntRe(DiFfRG::za4_num::tr22(fenv));
      const auto _interp92 = ZA4(0.7071067811865475 * sqrt(powr<2>(l1) + (-cosl1p1 + cosl1p3) * l1 * p + 2. * powr<2>(p)));
      const auto _interp93 = ntRe(DiFfRG::za4_num::tr23(fenv));
    ...
    // clang-format on
    {
      ...
      const auto _interp93 = ntRe(DiFfRG::za4_num::tr23(fenv));
      const auto _interp94 = ZA4(0.7071067811865475 * sqrt(powr<2>(l1) + (-cosl1p2 + cosl1p3) * l1 * p + 2. * powr<2>(p)));
      const auto _interp156 = ntIm(DiFfRG::za4_num::tr69(fenv));
      ...
      const auto _interp177 = ntIm(DiFfRG::za4_num::tr70(fenv));
      const auto _interp178 = ntIm(DiFfRG::za4_num::tr71(fenv));
      const auto _interp180 = ZAqbq1(0.3333333333333333 * sqrt(6. * powr<2>(l1) - 6. * (cosl1p1 + 2. * cosl1p2) * l1 * p + 10. * powr<2>(p)));
      const auto _interp184 = ntIm(DiFfRG::za4_num::tr72(fenv));
      const auto _interp185 = ntIm(DiFfRG::za4_num::tr59(fenv));
      const auto _interp187 = ZAqbq1(0.3333333333333333 * sqrt(6. * powr<2>(l1) - 6. * (cosl1p1 + cosl1p2 - cosl1p3) * l1 * p + 10. * powr<2>(p)));
      const auto _interp191 = ntIm(DiFfRG::za4_num::tr60(fenv));
      const auto _interp192 = ntIm(DiFfRG::za4_num::tr57(fenv));
      const auto _interp193 = ntIm(DiFfRG::za4_num::tr58(fenv));
      const auto _interp194 = ntIm(DiFfRG::za4_num::tr61(fenv));
      ...
      const auto _interp204 = ntIm(DiFfRG::za4_num::tr62(fenv));
      const auto _interp205 = ntIm(DiFfRG::za4_num::tr75(fenv));
      const auto _interp207 = ntIm(DiFfRG::za4_num::tr76(fenv));
      const auto _interp208 = ntIm(DiFfRG::za4_num::tr77(fenv));
      ...
      const auto _interp214 = ntIm(DiFfRG::za4_num::tr78(fenv));
      const auto _interp215 = ntIm(DiFfRG::za4_num::tr73(fenv));
      ...
      const auto _interp221 = ntIm(DiFfRG::za4_num::tr74(fenv));
      const auto _interp222 = ntIm(DiFfRG::za4_num::tr79(fenv));
      const auto _interp223 = ZAqbq1(0.3333333333333333 * sqrt(6. * powr<2>(l1) - 6. * (cosl1p2 + 2. * cosl1p3) * l1 * p + 10. * powr<2>(p)));
      const auto _interp224 = ntIm(DiFfRG::za4_num::tr80(fenv));
      const auto _interp225 = ntIm(DiFfRG::za4_num::tr63(fenv));
      ...
      const auto _interp231 = ntIm(DiFfRG::za4_num::tr64(fenv));
      const auto _interp232 = ntIm(DiFfRG::za4_num::tr65(fenv));
      ...
      const auto _interp238 = ntIm(DiFfRG::za4_num::tr66(fenv));
      const auto _interp239 = ntIm(DiFfRG::za4_num::tr67(fenv));
      const auto _interp240 = ZAqbq1(0.3333333333333333 * sqrt(6. * powr<2>(l1) + 6. * (cosl1p2 + 2. * cosl1p3) * l1 * p + 10. * powr<2>(p)));
      const auto _interp241 = ntIm(DiFfRG::za4_num::tr68(fenv));
    ...
    // clang-format on
    {
      ...
      // clang-format off
      using _T = decltype(complex<double>(0.,0.000850340136054422) + _den1 + _den10 + _den11 + _den12 + _den13 + _den14 + _den15 + _den16 + _den17 + _den18 + _den19 + _den2 + _den20 + _den21 + _den22 + _den23 + _den24 + _den25 + _den26 + _den27 + _den28 + _den29 + _den3 + _den30 + _den31 + _den32 + _den33 + _den34 + _den35 + _den36 + _den37 + _den4 + _den5 + _den6 + _den7 + _den8 + _den9 + DiFfRG::za4_num::tr0(fenv) + DiFfRG::za4_num::tr10(fenv) + DiFfRG::za4_num::tr11(fenv) + DiFfRG::za4_num::tr12(fenv) + DiFfRG::za4_num::tr13(fenv) + DiFfRG::za4_num::tr14(fenv) + DiFfRG::za4_num::tr15(fenv) + DiFfRG::za4_num::tr16(fenv) + DiFfRG::za4_num::tr17(fenv) + DiFfRG::za4_num::tr18(fenv) + DiFfRG::za4_num::tr19(fenv) + DiFfRG::za4_num::tr1(fenv) + DiFfRG::za4_num::tr20(fenv) + DiFfRG::za4_num::tr21(fenv) + DiFfRG::za4_num::tr22(fenv) + DiFfRG::za4_num::tr23(fenv) + DiFfRG::za4_num::tr24(fenv) + DiFfRG::za4_num::tr25(fenv) + DiFfRG::za4_num::tr26(fenv) + DiFfRG::za4_num::tr27(fenv) + DiFfRG::za4_num::tr28(fenv) + DiFfRG::za4_num::tr29(fenv) + DiFfRG::za4_num::tr2(fenv) + DiFfRG::za4_num::tr30(fenv) + DiFfRG::za4_num::tr31(fenv) + DiFfRG::za4_num::tr32(fenv) + DiFfRG::za4_num::tr33(fenv) + DiFfRG::za4_num::tr34(fenv) + DiFfRG::za4_num::tr35(fenv) + DiFfRG::za4_num::tr36(fenv) + DiFfRG::za4_num::tr37(fenv) + DiFfRG::za4_num::tr38(fenv) + DiFfRG::za4_num::tr39(fenv) + DiFfRG::za4_num::tr3(fenv) + DiFfRG::za4_num::tr40(fenv) + DiFfRG::za4_num::tr41(fenv) + DiFfRG::za4_num::tr42(fenv) + DiFfRG::za4_num::tr43(fenv) + DiFfRG::za4_num::tr44(fenv) + DiFfRG::za4_num::tr45(fenv) + DiFfRG::za4_num::tr46(fenv) + DiFfRG::za4_num::tr47(fenv) + DiFfRG::za4_num::tr48(fenv) + DiFfRG::za4_num::tr49(fenv) + DiFfRG::za4_num::tr4(fenv) + DiFfRG::za4_num::tr50(fenv) + DiFfRG::za4_num::tr51(fenv) + DiFfRG::za4_num::tr52(fenv) + DiFfRG::za4_num::tr53(fenv) + DiFfRG::za4_num::tr54(fenv) + DiFfRG::za4_num::tr55(fenv) + DiFfRG::za4_num::tr56(fenv) + DiFfRG::za4_num::tr57(fenv) + DiFfRG::za4_num::tr58(fenv) + DiFfRG::za4_num::tr59(fenv) + DiFfRG::za4_num::tr5(fenv) + DiFfRG::za4_num::tr60(fenv) + DiFfRG::za4_num::tr61(fenv) + DiFfRG::za4_num::tr62(fenv) + DiFfRG::za4_num::tr63(fenv) + DiFfRG::za4_num::tr64(fenv) + DiFfRG::za4_num::tr65(fenv) + DiFfRG::za4_num::tr66(fenv) + DiFfRG::za4_num::tr67(fenv) + DiFfRG::za4_num::tr68(fenv) + DiFfRG::za4_num::tr69(fenv) + DiFfRG::za4_num::tr6(fenv) + DiFfRG::za4_num::tr70(fenv) + DiFfRG::za4_num::tr71(fenv) + DiFfRG::za4_num::tr72(fenv) + DiFfRG::za4_num::tr73(fenv) + DiFfRG::za4_num::tr74(fenv) + DiFfRG::za4_num::tr75(fenv) + DiFfRG::za4_num::tr76(fenv) + DiFfRG::za4_num::tr77(fenv) + DiFfRG::za4_num::tr78(fenv) + DiFfRG::za4_num::tr79(fenv) + DiFfRG::za4_num::tr7(fenv) + DiFfRG::za4_num::tr80(fenv) + DiFfRG::za4_num::tr8(fenv) + DiFfRG::za4_num::tr9(fenv) + _interp1 + _interp10 + _interp100 + _interp101 + _interp102 + _interp103 + _interp104 + _interp105 + _interp106 + _interp107 + _interp108 + _interp109 + _interp11 + _interp110 + _interp111 + _interp112 + _interp113 + _interp114 + _interp115 + _interp116 + _interp117 + _interp118 + _interp119 + _interp12 + _interp120 + _interp121 + _interp122 + _interp123 + _interp124 + _interp125 + _interp126 + _interp127 + _interp128 + _interp129 + _interp13 + _interp130 + _interp131 + _interp132 + _interp133 + _interp134 + _interp135 + _interp136 + _interp137 + _interp138 + _interp139 + _interp14 + _interp140 + _interp141 + _interp142 + _interp143 + _interp144 + _interp145 + _interp146 + _interp147 + _interp148 + _interp149 + _interp15 + _interp150 + _interp151 + _interp152 + _interp153 + _interp154 + _interp155 + _interp156 + _interp157 + _interp158 + _interp159 + _interp16 + _interp160 + _interp17 + _interp18 + _interp19 + _interp2 + _interp20 + _interp21 + _interp22 + _interp23 + _interp24 + _interp25 + _interp26 + _interp27 + _interp28 + _interp29 + _interp3 + _interp30 + _interp31 + _interp32 + _interp33 + _interp34 + _interp35 + _interp36 + _interp37 + _interp38 + _interp39 + _interp4 + _interp40 + _interp41 + _interp42 + _interp43 + _interp44 + _interp45 + _interp46 + _interp47 + _interp48 + _interp49 + _interp5 + _interp50 + _interp51 + _interp52 + _interp53 + _interp54 + _interp55 + _interp56 + _interp57 + _interp58 + _interp59 + _interp6 + _interp60 + _interp61 + _interp62 + _interp63 + _interp64 + _interp65 + _interp66 + _interp67 + _interp68 + _interp69 + _interp7 + _interp70 + _interp71 + _interp72 + _interp73 + _interp74 + _interp75 + _interp76 + _interp77 + _interp78 + _interp79 + _interp8 + _interp80 + _interp81 + _interp82 + _interp83 + _interp84 + _interp85 + _interp86 + _interp87 + _interp88 + _interp89 + _interp9 + _interp90 + _interp91 + _interp92 + _interp93 + _interp94 + _interp95 + _interp96 + _interp97 + _interp98 + _interp99 + k + l1);
      // clang-format on
      _T _acc{};
      { // subkernel 1
      // clang-format off
      _acc += fma(0.0004251700680272108, _den21 * _den26 * _den3 * _den9 * DiFfRG::za4_num::tr45(fenv) * _interp62 * _interp63 * _interp64 * _interp65 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))), fma(-0.0004251700680272108, _den21 * _den26 * _den3 * _den9 * DiFfRG::za4_num::tr46(fenv) * _interp62 * _interp63 * _interp64 * _interp65 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))), fma(0.0004251700680272108, _den10 * _den21 * _den26 * _den3 * DiFfRG::za4_num::tr47(fenv) * _interp63 * _interp65 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp73 * _interp74, fma(-0.0004251700680272108, _den10 * _den21 * _den26 * _den3 * DiFfRG::za4_num::tr48(fenv) * _interp63 * _interp65 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp73 * _interp74, fma(-0.0004251700680272108, _den13 * _den21 * _den3 * _den9 * DiFfRG::za4_num::tr33(fenv) * _interp62 * _interp64 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp76 * _interp77, fma(0.0004251700680272108, _den13 * _den21 * _den3 * _den9 * DiFfRG::za4_num::tr34(fenv) * _interp62 * _interp64 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp76 * _interp77, fma(-0.0004251700680272108, _den10 * _den13 * _den21 * _den3 * DiFfRG::za4_num::tr35(fenv) * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp73 * _interp74 * _interp76 * _interp77, fma(0.0004251700680272108, _den10 * _den13 * _den21 * _den3 * DiFfRG::za4_num::tr36(fenv) * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp73 * _interp74 * _interp76 * _interp77, fma(0.0004251700680272108, _den11 * _den22 * _den3 * _den9 * DiFfRG::za4_num::tr37(fenv) * _interp62 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp79 * _interp80 * _interp81, fma(-0.0004251700680272108, _den11 * _den22 * _den3 * _den9 * DiFfRG::za4_num::tr38(fenv) * _interp62 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp79 * _interp80 * _interp81, fma(0.0004251700680272108, _den22 * _den26 * _den3 * _den9 * DiFfRG::za4_num::tr49(fenv) * _interp62 * _interp63 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp80 * _interp84, fma(-0.0004251700680272108, _den22 * _den26 * _den3 * _den9 * DiFfRG::za4_num::tr50(fenv) * _interp62 * _interp63 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp80 * _interp84, fma(0.0004251700680272108, _den12 * _den22 * _den26 * _den3 * DiFfRG::za4_num::tr51(fenv) * _interp63 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp84 * _interp85 * _interp86, fma(-0.0004251700680272108, _den12 * _den22 * _den26 * _den3 * DiFfRG::za4_num::tr52(fenv) * _interp63 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp84 * _interp85 * _interp86, 0.))))))))))))));
      // clang-format on
      }
      { // subkernel 2
      // clang-format off
      _acc += fma(0.0004251700680272108, _den10 * _den23 * _den26 * _den3 * DiFfRG::za4_num::tr53(fenv) * _interp63 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp73 * _interp88 * _interp89, fma(-0.0004251700680272108, _den10 * _den23 * _den26 * _den3 * DiFfRG::za4_num::tr54(fenv) * _interp63 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp73 * _interp88 * _interp89, fma(0.0004251700680272108, _den12 * _den23 * _den26 * _den3 * DiFfRG::za4_num::tr55(fenv) * _interp63 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp85 * _interp88 * _interp91, fma(-0.0004251700680272108, _den12 * _den23 * _den26 * _den3 * DiFfRG::za4_num::tr56(fenv) * _interp63 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp85 * _interp88 * _interp91, fma(-0.0004251700680272108, _den10 * _den13 * _den24 * _den3 * DiFfRG::za4_num::tr39(fenv) * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp73 * _interp76 * _interp92 * _interp93, fma(0.0004251700680272108, _den10 * _den13 * _den24 * _den3 * DiFfRG::za4_num::tr40(fenv) * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp73 * _interp76 * _interp92 * _interp93, fma(-0.0004251700680272108, _den11 * _den25 * _den3 * _den9 * DiFfRG::za4_num::tr41(fenv) * _interp62 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp79 * _interp95 * _interp96, fma(0.0004251700680272108, _den11 * _den25 * _den3 * _den9 * DiFfRG::za4_num::tr42(fenv) * _interp62 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp79 * _interp95 * _interp96, fma(-0.0004251700680272108, _den13 * _den25 * _den3 * _den9 * DiFfRG::za4_num::tr43(fenv) * _interp62 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp76 * _interp95 * _interp98, fma(0.0004251700680272108, _den13 * _den25 * _den3 * _den9 * DiFfRG::za4_num::tr44(fenv) * _interp62 * (_interp1 * _interp66 + _interp3 * (_interp67 + 50. * (-_interp66 + _interp68))) * _interp76 * _interp95 * _interp98, fma(0.0004251700680272108, _den17 * _den2 * _den20 * _den7 * DiFfRG::za4_num::tr10(fenv) * _interp13 * _interp14 * _interp15 * _interp16 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den16 * _den2 * _den20 * _den7 * DiFfRG::za4_num::tr8(fenv) * _interp13 * _interp14 * _interp19 * _interp20 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den16 * _den2 * _den20 * _den4 * DiFfRG::za4_num::tr9(fenv) * _interp14 * _interp20 * _interp23 * _interp24 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den17 * _den2 * _den20 * _den5 * DiFfRG::za4_num::tr11(fenv) * _interp14 * _interp15 * _interp27 * _interp28 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), 0.))))))))))))));
      // clang-format on
      }
      { // subkernel 3
      // clang-format off
      _acc += fma(0.0004251700680272108, _den15 * _den2 * _den20 * _den5 * DiFfRG::za4_num::tr6(fenv) * _interp14 * _interp27 * _interp31 * _interp32 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den15 * _den2 * _den20 * _den4 * DiFfRG::za4_num::tr7(fenv) * _interp14 * _interp23 * _interp32 * _interp33 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den16 * _den2 * _den4 * _den6 * DiFfRG::za4_num::tr2(fenv) * _interp23 * _interp24 * _interp36 * _interp37 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den15 * _den2 * _den5 * _den8 * DiFfRG::za4_num::tr0(fenv) * _interp27 * _interp31 * _interp40 * _interp41 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den15 * _den2 * _den4 * _den8 * DiFfRG::za4_num::tr1(fenv) * _interp23 * _interp33 * _interp40 * _interp41 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den19 * _den2 * _den4 * _den6 * DiFfRG::za4_num::tr4(fenv) * _interp23 * _interp36 * _interp44 * _interp45 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den18 * _den2 * _den5 * _den8 * DiFfRG::za4_num::tr3(fenv) * _interp27 * _interp40 * _interp48 * _interp49 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den19 * _den2 * _den4 * _den8 * DiFfRG::za4_num::tr5(fenv) * _interp23 * _interp40 * _interp44 * _interp50 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den15 * _den2 * _den5 * DiFfRG::za4_num::tr24(fenv) * _interp27 * _interp31 * _interp51 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den15 * _den2 * _den20 * DiFfRG::za4_num::tr13(fenv) * _interp14 * _interp32 * _interp51 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den15 * _den2 * _den4 * DiFfRG::za4_num::tr25(fenv) * _interp23 * _interp33 * _interp51 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den15 * _den2 * _den8 * DiFfRG::za4_num::tr12(fenv) * _interp40 * _interp41 * _interp51 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den15 * _den2 * DiFfRG::za4_num::tr26(fenv) * powr<2>(_interp51) * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den16 * _den2 * _den7 * DiFfRG::za4_num::tr27(fenv) * _interp13 * _interp19 * _interp52 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), 0.))))))))))))));
      // clang-format on
      }
      { // subkernel 4
      // clang-format off
      _acc += fma(0.0004251700680272108, _den16 * _den2 * _den20 * DiFfRG::za4_num::tr14(fenv) * _interp14 * _interp20 * _interp52 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den16 * _den2 * _den4 * DiFfRG::za4_num::tr28(fenv) * _interp23 * _interp24 * _interp52 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den16 * _den2 * DiFfRG::za4_num::tr29(fenv) * powr<2>(_interp52) * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den17 * _den2 * _den20 * DiFfRG::za4_num::tr16(fenv) * _interp14 * _interp15 * _interp53 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den17 * _den2 * _den7 * DiFfRG::za4_num::tr30(fenv) * _interp13 * _interp16 * _interp53 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den17 * _den2 * _den5 * DiFfRG::za4_num::tr31(fenv) * _interp27 * _interp28 * _interp53 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den17 * _den2 * DiFfRG::za4_num::tr32(fenv) * powr<2>(_interp53) * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den18 * _den2 * _den5 * DiFfRG::za4_num::tr15(fenv) * _interp27 * _interp48 * _interp54 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den19 * _den2 * _den4 * DiFfRG::za4_num::tr17(fenv) * _interp23 * _interp44 * _interp55 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den2 * _den4 * _den6 * DiFfRG::za4_num::tr18(fenv) * _interp23 * _interp36 * _interp56 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den2 * _den20 * _den7 * DiFfRG::za4_num::tr19(fenv) * _interp13 * _interp14 * _interp57 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den2 * _den20 * _den5 * DiFfRG::za4_num::tr20(fenv) * _interp14 * _interp27 * _interp58 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den2 * _den20 * _den4 * DiFfRG::za4_num::tr21(fenv) * _interp14 * _interp23 * _interp59 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(0.0004251700680272108, _den2 * _den4 * _den8 * DiFfRG::za4_num::tr22(fenv) * _interp23 * _interp40 * _interp60 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), 0.))))))))))))));
      // clang-format on
      }
      { // subkernel 5
      // clang-format off
      _acc += fma(0.0004251700680272108, _den2 * _den5 * _den8 * DiFfRG::za4_num::tr23(fenv) * _interp27 * _interp40 * _interp61 * (_interp1 * _interp2 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(complex<double>(0.,-0.000850340136054422), _den14 * _den28 * _den32 * _den37 * DiFfRG::za4_num::tr71(fenv) * _interp100 * _interp102 * _interp119 * _interp120 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,0.000850340136054422), _den14 * _den28 * _den32 * _den37 * DiFfRG::za4_num::tr72(fenv) * _interp100 * _interp102 * _interp119 * _interp120 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,0.000850340136054422), _den14 * _den28 * _den31 * _den32 * DiFfRG::za4_num::tr57(fenv) * _interp119 * _interp120 * _interp124 * _interp125 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,-0.000850340136054422), _den14 * _den28 * _den31 * _den32 * DiFfRG::za4_num::tr58(fenv) * _interp119 * _interp120 * _interp124 * _interp125 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,-0.000850340136054422), _den14 * _den30 * _den33 * _den37 * DiFfRG::za4_num::tr77(fenv) * _interp100 * _interp138 * _interp139 * _interp140 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,0.000850340136054422), _den14 * _den30 * _den33 * _den37 * DiFfRG::za4_num::tr78(fenv) * _interp100 * _interp138 * _interp139 * _interp140 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,-0.000850340136054422), _den14 * _den28 * _den34 * _den37 * DiFfRG::za4_num::tr73(fenv) * _interp100 * _interp119 * _interp144 * _interp145 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,0.000850340136054422), _den14 * _den28 * _den34 * _den37 * DiFfRG::za4_num::tr74(fenv) * _interp100 * _interp119 * _interp144 * _interp145 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,-0.000850340136054422), _den14 * _den30 * _den34 * _den37 * DiFfRG::za4_num::tr79(fenv) * _interp100 * _interp139 * _interp144 * _interp149 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,0.000850340136054422), _den14 * _den30 * _den34 * _den37 * DiFfRG::za4_num::tr80(fenv) * _interp100 * _interp139 * _interp144 * _interp149 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,0.000850340136054422), _den14 * _den28 * _den31 * _den35 * DiFfRG::za4_num::tr63(fenv) * _interp119 * _interp124 * _interp150 * _interp151 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,-0.000850340136054422), _den14 * _den28 * _den31 * _den35 * DiFfRG::za4_num::tr64(fenv) * _interp119 * _interp124 * _interp150 * _interp151 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,-0.000850340136054422), _den14 * _den27 * _den32 * _den37 * DiFfRG::za4_num::tr69(fenv) * _interp100 * _interp101 * _interp102 * _interp99 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), 0.))))))))))))));
      // clang-format on
      }
      { // subkernel 6
      // clang-format off
      _acc += fma(complex<double>(0.,0.000850340136054422), _den14 * _den27 * _den32 * _den37 * DiFfRG::za4_num::tr70(fenv) * _interp100 * _interp101 * _interp102 * _interp99 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,0.000850340136054422), _den14 * _den27 * _den31 * _den32 * DiFfRG::za4_num::tr59(fenv) * _interp101 * _interp124 * _interp125 * _interp99 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,-0.000850340136054422), _den14 * _den27 * _den31 * _den32 * DiFfRG::za4_num::tr60(fenv) * _interp101 * _interp124 * _interp125 * _interp99 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,-0.000850340136054422), _den14 * _den27 * _den29 * _den33 * DiFfRG::za4_num::tr61(fenv) * _interp129 * _interp130 * _interp131 * _interp99 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,0.000850340136054422), _den14 * _den27 * _den29 * _den33 * DiFfRG::za4_num::tr62(fenv) * _interp129 * _interp130 * _interp131 * _interp99 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,-0.000850340136054422), _den14 * _den27 * _den33 * _den37 * DiFfRG::za4_num::tr75(fenv) * _interp100 * _interp130 * _interp138 * _interp99 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,0.000850340136054422), _den14 * _den27 * _den33 * _den37 * DiFfRG::za4_num::tr76(fenv) * _interp100 * _interp130 * _interp138 * _interp99 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,0.000850340136054422), _den14 * _den27 * _den29 * _den36 * DiFfRG::za4_num::tr65(fenv) * _interp129 * _interp155 * _interp156 * _interp99 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,-0.000850340136054422), _den14 * _den27 * _den29 * _den36 * DiFfRG::za4_num::tr66(fenv) * _interp129 * _interp155 * _interp156 * _interp99 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,0.000850340136054422), _den14 * _den27 * _den31 * _den36 * DiFfRG::za4_num::tr67(fenv) * _interp124 * _interp155 * _interp160 * _interp99 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), fma(complex<double>(0.,-0.000850340136054422), _den14 * _den27 * _den31 * _den36 * DiFfRG::za4_num::tr68(fenv) * _interp124 * _interp155 * _interp160 * _interp99 * (-_interp103 * _interp104 * powr<-1>(l1) - _interp105 * (_interp106 + 50. * (-_interp104 + _interp107)) * powr<-1>(l1)), 0.)))))))))));
      // clang-format on
      }
      return _acc;
    }
