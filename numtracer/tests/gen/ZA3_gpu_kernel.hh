...
namespace DiFfRG
{
  class ZA3_gpu_kernel
  {
    ...
    // clang-format on
    {
      ...
      const double dr_0 = Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)));
      const double dr_1 = -sqrt(powr<-1>(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))) * RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)) * Zq(k) - Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)));
      const double dr_2 = Mq(sqrt(powr<2>(l1) + 2. * cosl1p2 * l1 * p + powr<2>(p)));
      const double dr_3 = -sqrt(powr<-1>(powr<2>(l1) + 2. * cosl1p2 * l1 * p + powr<2>(p))) * RF(powr<2>(k), powr<2>(l1) + 2. * cosl1p2 * l1 * p + powr<2>(p)) * Zq(k) - Zq(sqrt(powr<2>(l1) + 2. * cosl1p2 * l1 * p + powr<2>(p)));
      ...
      DiFfRG::za3_gpu::fill(fenv, l1, cos1, cos2, p, dr_0, dr_1, dr_2, dr_3, dr_4, dr_5, dr_6, dr_7, dr_8, dr_9);
      const auto _interp1 = ntRe(DiFfRG::za3_gpu::tr1(fenv));
      ...
      const auto _interp8 = RB(powr<2>(k), powr<2>(l1) - 2. * cosl1p2 * l1 * p + powr<2>(p));
      const auto _interp9 = ZA(sqrt(powr<2>(l1) - 2. * cosl1p2 * l1 * p + powr<2>(p)));
      ...
      const auto _interp15 = ntRe(DiFfRG::za3_gpu::tr2(fenv));
      ...
      const auto _interp20 = ntRe(DiFfRG::za3_gpu::tr0(fenv));
      ...
      const auto _interp41 = ntRe(DiFfRG::za3_gpu::tr9(fenv));
      const auto _interp42 = ntRe(DiFfRG::za3_gpu::tr10(fenv));
      ...
      const auto _interp46 = ntRe(DiFfRG::za3_gpu::tr11(fenv));
      const auto _interp47 = ntRe(DiFfRG::za3_gpu::tr6(fenv));
      ...
      const auto _interp51 = ntRe(DiFfRG::za3_gpu::tr7(fenv));
      ...
      const auto _den4 = powr<-1>(_interp16 * _interp3 + _interp17 * (powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)));
      const auto _den5 = powr<-1>(_interp3 * _interp8 + _interp9 * (powr<2>(l1) - 2. * cosl1p2 * l1 * p + powr<2>(p)));
      ...
      const auto _den10 = powr<-1>(_interp10 * _interp3 + _interp11 * (powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
      const auto _den11 = -powr<-1>(_interp10 * _interp35 + _interp40 * (powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
      const auto _cse1 = powr<-2>(p);
      const auto _cse2 = -_interp3;
      // clang-format off
      return fma(-0.001683501683501684, _cse1 * _den11 * _den3 * _den7 * _interp31 * _interp32 * _interp33 * _interp34 * (_interp2 * _interp35 + (_interp36 + 50. * (-_interp35 + _interp37)) * _interp4), fma(0.001683501683501684, _cse1 * _den11 * _den3 * _den7 * _interp32 * _interp33 * _interp34 * (_interp2 * _interp35 + (_interp36 + 50. * (-_interp35 + _interp37)) * _interp4) * _interp41, fma(-0.001683501683501684, _cse1 * _den11 * _den3 * _den8 * _interp33 * (_interp2 * _interp35 + (_interp36 + 50. * (-_interp35 + _interp37)) * _interp4) * _interp42 * _interp43 * _interp44, fma(0.001683501683501684, _cse1 * _den11 * _den3 * _den8 * _interp33 * (_interp2 * _interp35 + (_interp36 + 50. * (-_interp35 + _interp37)) * _interp4) * _interp43 * _interp44 * _interp46, fma(0.001683501683501684, _cse1 * _den3 * _den7 * _den9 * _interp32 * (_interp2 * _interp35 + (_interp36 + 50. * (-_interp35 + _interp37)) * _interp4) * _interp47 * _interp48 * _interp49, fma(-0.001683501683501684, _cse1 * _den3 * _den7 * _den9 * _interp32 * (_interp2 * _interp35 + (_interp36 + 50. * (-_interp35 + _interp37)) * _interp4) * _interp48 * _interp49 * _interp51, fma(-0.001683501683501684, _cse1 * _den10 * _den2 * _den5 * _interp1 * _interp12 * _interp13 * _interp14 * (_interp2 * _interp3 + _interp4 * (_interp5 + 50. * _den1 * (_cse2 + _interp6) * powr<6>(k))), fma(-0.001683501683501684, _cse1 * _den10 * _den2 * _den4 * _interp13 * _interp15 * _interp18 * _interp19 * (_interp2 * _interp3 + _interp4 * (_interp5 + 50. * _den1 * (_cse2 + _interp6) * powr<6>(k))), fma(-0.001683501683501684, _cse1 * _den2 * _den4 * _den6 * _interp18 * _interp20 * _interp23 * _interp24 * (_interp2 * _interp3 + _interp4 * (_interp5 + 50. * _den1 * (_cse2 + _interp6) * powr<6>(k))), fma(-0.001683501683501684, _cse1 * _den2 * _den4 * _interp18 * _interp25 * _interp26 * (_interp2 * _interp3 + _interp4 * (_interp5 + 50. * _den1 * (_cse2 + _interp6) * powr<6>(k))), fma(-0.001683501683501684, _cse1 * _den2 * _den5 * _interp12 * _interp27 * _interp28 * (_interp2 * _interp3 + _interp4 * (_interp5 + 50. * _den1 * (_cse2 + _interp6) * powr<6>(k))), fma(-0.001683501683501684, _cse1 * _den10 * _den2 * _interp13 * _interp29 * _interp30 * (_interp2 * _interp3 + _interp4 * (_interp5 + 50. * _den1 * (_cse2 + _interp6) * powr<6>(k))), 0.))))))))))));
      // clang-format on
    }
    ...
    // clang-format on
    {
      ...
      const auto _interp29 = ntRe(DiFfRG::za3_gpu::tr5(fenv));
      const auto _interp30 = ZA4(0.5 * sqrt(2. * powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + 3. * powr<2>(p)));
      const auto _interp52 = ntIm(DiFfRG::za3_gpu::tr14(fenv));
      const auto _interp53 = ZAqbq1(0.816496580927726 * sqrt(powr<2>(l1) - cosl1p1 * l1 * p + powr<2>(p)));
      const auto _interp54 = ZAqbq1(0.816496580927726 * sqrt(powr<2>(l1) - (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
      const auto _interp55 = ZAqbq1(sqrt(0.6666666666666666 * powr<2>(l1) - 0.6666666666666666 * (2. * cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
      const auto _interp56 = RFdot(powr<2>(k), powr<2>(l1));
      const auto _interp57 = Zq(k);
      const auto _interp58 = RF(powr<2>(k), powr<2>(l1));
      const auto _interp59 = dtZq(k);
      const auto _interp60 = Zq(1.02 * k);
      const auto _interp61 = Mq(l1);
      const auto _interp62 = Zq(l1);
      const auto _interp63 = Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)));
      const auto _interp64 = RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p));
      const auto _interp65 = Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)));
      const auto _interp66 = Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
      const auto _interp67 = RF(powr<2>(k), powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p));
      const auto _interp68 = Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
      const auto _interp69 = ntIm(DiFfRG::za3_gpu::tr15(fenv));
      const auto _interp70 = ntIm(DiFfRG::za3_gpu::tr16(fenv));
      const auto _interp71 = ZAqbq1(0.816496580927726 * sqrt(powr<2>(l1) - cosl1p2 * l1 * p + powr<2>(p)));
      const auto _interp72 = ZAqbq1(sqrt(0.6666666666666666 * powr<2>(l1) - 0.6666666666666666 * (cosl1p1 + 2. * cosl1p2) * l1 * p + powr<2>(p)));
      ...
      const auto _interp76 = ntIm(DiFfRG::za3_gpu::tr17(fenv));
      const auto _interp77 = ntIm(DiFfRG::za3_gpu::tr12(fenv));
      const auto _interp78 = ZAqbq1(0.816496580927726 * sqrt(powr<2>(l1) + cosl1p2 * l1 * p + powr<2>(p)));
      const auto _interp79 = ZAqbq1(sqrt(0.6666666666666666 * powr<2>(l1) + 0.6666666666666666 * (-cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
      const auto _interp80 = Mq(sqrt(powr<2>(l1) + 2. * cosl1p2 * l1 * p + powr<2>(p)));
      const auto _interp81 = RF(powr<2>(k), powr<2>(l1) + 2. * cosl1p2 * l1 * p + powr<2>(p));
      const auto _interp82 = Zq(sqrt(powr<2>(l1) + 2. * cosl1p2 * l1 * p + powr<2>(p)));
      const auto _interp83 = ntIm(DiFfRG::za3_gpu::tr13(fenv));
      const auto _den13 = powr<-1>(powr<2>(_interp63) + powr<2>(_interp57 * _interp64 + _interp65 * sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))));
      const auto _den14 = powr<-1>(powr<2>(_interp73) + powr<2>(_interp57 * _interp74 + _interp75 * sqrt(powr<2>(l1) - 2. * cosl1p2 * l1 * p + powr<2>(p))));
      const auto _den15 = powr<-1>(powr<2>(_interp80) + powr<2>(_interp57 * _interp81 + _interp82 * sqrt(powr<2>(l1) + 2. * cosl1p2 * l1 * p + powr<2>(p))));
      const auto _den16 = powr<-1>(powr<2>(_interp66) + powr<2>(_interp68) * (powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)) + _interp57 * _interp67 * (_interp57 * _interp67 + 2. * _interp68 * sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p))));
      // clang-format off
      using _T = decltype(_den1 + _den11 + _den13 + _den14 + _den15 + _den16 + _den2 + _den4 + _den5 + _interp1 + _interp10 + _interp11 + _interp12 + _interp13 + _interp14 + _interp15 + _interp16 + _interp17 + _interp18 + _interp19 + _interp2 + _interp20 + _interp21 + _interp22 + _interp23 + _interp24 + _interp25 + _interp26 + _interp27 + _interp28 + _interp29 + _interp3 + _interp30 + _interp31 + _interp32 + _interp33 + _interp34 + _interp35 + _interp36 + _interp37 + _interp38 + _interp39 + _interp4 + _interp40 + _interp41 + _interp42 + _interp43 + _interp44 + _interp45 + _interp46 + _interp47 + _interp48 + _interp49 + _interp5 + _interp50 + _interp51 + _interp52 + _interp53 + _interp54 + _interp55 + _interp56 + _interp57 + _interp58 + _interp59 + _interp6 + _interp60 + _interp61 + _interp62 + _interp63 + _interp64 + _interp65 + _interp66 + _interp67 + _interp68 + _interp69 + _interp7 + _interp70 + _interp71 + _interp72 + _interp73 + _interp74 + _interp75 + _interp76 + _interp77 + _interp78 + _interp79 + _interp8 + _interp80 + _interp81 + _interp82 + _interp83 + _interp9 + cosl1p1 + cosl1p2 + k + l1 + p);
      // clang-format on
      _T _acc{};
      { // subkernel 1
        const auto _den3 = powr<-2>(_interp35 * _interp4 + _interp38 * powr<2>(l1));
      ...
      { // subkernel 2
        const auto _den10 = powr<-2>(powr<2>(_interp61) + powr<2>(_interp57 * _interp58 + _interp62 * l1));
        const auto _cse1 = powr<-1>(l1);
        // clang-format off
        _acc += fma(0.003367003367003367, _den10 * _den13 * _den16 * _interp52 * _interp53 * _interp54 * _interp55 * (-_cse1 * _interp56 * _interp57 - _cse1 * _interp58 * (_interp59 + 50. * (-_interp57 + _interp60))) * powr<-2>(p), fma(-0.003367003367003367, _den10 * _den13 * _den16 * _interp53 * _interp54 * _interp55 * (-_cse1 * _interp56 * _interp57 - _cse1 * _interp58 * (_interp59 + 50. * (-_interp57 + _interp60))) * _interp69 * powr<-2>(p), fma(0.003367003367003367, _den10 * _den14 * _den16 * _interp54 * (-_cse1 * _interp56 * _interp57 - _cse1 * _interp58 * (_interp59 + 50. * (-_interp57 + _interp60))) * _interp70 * _interp71 * _interp72 * powr<-2>(p), fma(-0.003367003367003367, _den10 * _den14 * _den16 * _interp54 * (-_cse1 * _interp56 * _interp57 - _cse1 * _interp58 * (_interp59 + 50. * (-_interp57 + _interp60))) * _interp71 * _interp72 * _interp76 * powr<-2>(p), fma(-0.003367003367003367, _den10 * _den13 * _den15 * _interp53 * (-_cse1 * _interp56 * _interp57 - _cse1 * _interp58 * (_interp59 + 50. * (-_interp57 + _interp60))) * _interp77 * _interp78 * _interp79 * powr<-2>(p), fma(0.003367003367003367, _den10 * _den13 * _den15 * _interp53 * (-_cse1 * _interp56 * _interp57 - _cse1 * _interp58 * (_interp59 + 50. * (-_interp57 + _interp60))) * _interp78 * _interp79 * _interp83 * powr<-2>(p), fma(-0.001683501683501684, _den2 * _den4 * _interp18 * _interp25 * _interp26 * (_interp2 * _interp3 + _interp4 * (_interp5 + 50. * _den1 * (-_interp3 + _interp6) * powr<6>(k))) * powr<-2>(p), fma(-0.001683501683501684, _den2 * _den5 * _interp12 * _interp27 * _interp28 * (_interp2 * _interp3 + _interp4 * (_interp5 + 50. * _den1 * (-_interp3 + _interp6) * powr<6>(k))) * powr<-2>(p), fma(-0.001683501683501684, _den11 * _den2 * _interp13 * _interp29 * _interp30 * (_interp2 * _interp3 + _interp4 * (_interp5 + 50. * _den1 * (-_interp3 + _interp6) * powr<6>(k))) * powr<-2>(p), 0.)))))))));
        // clang-format on
      }
      return _acc;
    }
    ...
    // clang-format on
    {
      ...
      const auto _interp40 = ZAqbq1(0.816496580927726 * sqrt(powr<2>(l1) - cosl1p1 * l1 * p + powr<2>(p)));
      const auto _interp41 = ZAqbq1(0.816496580927726 * sqrt(powr<2>(l1) - (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
      const auto _interp42 = ZAqbq1(sqrt(0.6666666666666666 * powr<2>(l1) - 0.6666666666666666 * (2. * cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
      const auto _interp43 = RFdot(powr<2>(k), powr<2>(l1));
      const auto _interp44 = Zq(k);
      const auto _interp45 = RF(powr<2>(k), powr<2>(l1));
      const auto _interp46 = dtZq(k);
      const auto _interp47 = Zq(1.02 * k);
      const auto _interp48 = Mq(l1);
      const auto _interp49 = Zq(l1);
      const auto _interp50 = Mq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)));
      const auto _interp51 = RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p));
      const auto _interp52 = Zq(sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p)));
      const auto _interp53 = Mq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
      const auto _interp54 = RF(powr<2>(k), powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p));
      const auto _interp55 = Zq(sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
      const auto _interp56 = ZAqbq1(0.816496580927726 * sqrt(powr<2>(l1) - cosl1p2 * l1 * p + powr<2>(p)));
      const auto _interp57 = ZAqbq1(sqrt(0.6666666666666666 * powr<2>(l1) - 0.6666666666666666 * (cosl1p1 + 2. * cosl1p2) * l1 * p + powr<2>(p)));
      const auto _interp58 = Mq(sqrt(powr<2>(l1) - 2. * cosl1p2 * l1 * p + powr<2>(p)));
      const auto _interp59 = RF(powr<2>(k), powr<2>(l1) - 2. * cosl1p2 * l1 * p + powr<2>(p));
      const auto _interp60 = Zq(sqrt(powr<2>(l1) - 2. * cosl1p2 * l1 * p + powr<2>(p)));
      const auto _interp61 = ZAqbq1(0.816496580927726 * sqrt(powr<2>(l1) + cosl1p2 * l1 * p + powr<2>(p)));
      const auto _interp62 = ZAqbq1(sqrt(0.6666666666666666 * powr<2>(l1) + 0.6666666666666666 * (-cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)));
      const auto _interp63 = Mq(sqrt(powr<2>(l1) + 2. * cosl1p2 * l1 * p + powr<2>(p)));
      const auto _interp64 = RF(powr<2>(k), powr<2>(l1) + 2. * cosl1p2 * l1 * p + powr<2>(p));
      const auto _interp65 = Zq(sqrt(powr<2>(l1) + 2. * cosl1p2 * l1 * p + powr<2>(p)));
      const auto _den13 = powr<-1>(powr<2>(_interp50) + powr<2>(_interp44 * _interp51 + _interp52 * sqrt(powr<2>(l1) - 2. * cosl1p1 * l1 * p + powr<2>(p))));
      const auto _den14 = powr<-1>(powr<2>(_interp58) + powr<2>(_interp44 * _interp59 + _interp60 * sqrt(powr<2>(l1) - 2. * cosl1p2 * l1 * p + powr<2>(p))));
      const auto _den15 = powr<-1>(powr<2>(_interp63) + powr<2>(_interp44 * _interp64 + _interp65 * sqrt(powr<2>(l1) + 2. * cosl1p2 * l1 * p + powr<2>(p))));
      const auto _den16 = powr<-1>(powr<2>(_interp53) + powr<2>(_interp55) * (powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p)) + _interp44 * _interp54 * (_interp44 * _interp54 + 2. * _interp55 * sqrt(powr<2>(l1) - 2. * (cosl1p1 + cosl1p2) * l1 * p + powr<2>(p))));
      // clang-format off
      using _T = decltype(complex<double>(0.,-0.003367003367003367) + _den1 + _den11 + _den13 + _den14 + _den15 + _den16 + _den2 + _den4 + _den5 + DiFfRG::za3_gpu::tr0(fenv) + DiFfRG::za3_gpu::tr10(fenv) + DiFfRG::za3_gpu::tr11(fenv) + DiFfRG::za3_gpu::tr12(fenv) + DiFfRG::za3_gpu::tr13(fenv) + DiFfRG::za3_gpu::tr14(fenv) + DiFfRG::za3_gpu::tr15(fenv) + DiFfRG::za3_gpu::tr16(fenv) + DiFfRG::za3_gpu::tr17(fenv) + DiFfRG::za3_gpu::tr1(fenv) + DiFfRG::za3_gpu::tr2(fenv) + DiFfRG::za3_gpu::tr3(fenv) + DiFfRG::za3_gpu::tr4(fenv) + DiFfRG::za3_gpu::tr5(fenv) + DiFfRG::za3_gpu::tr6(fenv) + DiFfRG::za3_gpu::tr7(fenv) + DiFfRG::za3_gpu::tr8(fenv) + DiFfRG::za3_gpu::tr9(fenv) + _interp1 + _interp10 + _interp11 + _interp12 + _interp13 + _interp14 + _interp15 + _interp16 + _interp17 + _interp18 + _interp19 + _interp2 + _interp20 + _interp21 + _interp22 + _interp23 + _interp24 + _interp25 + _interp26 + _interp27 + _interp28 + _interp29 + _interp3 + _interp30 + _interp31 + _interp32 + _interp33 + _interp34 + _interp35 + _interp36 + _interp37 + _interp38 + _interp39 + _interp4 + _interp40 + _interp41 + _interp42 + _interp43 + _interp44 + _interp45 + _interp46 + _interp47 + _interp48 + _interp49 + _interp5 + _interp50 + _interp51 + _interp52 + _interp53 + _interp54 + _interp55 + _interp56 + _interp57 + _interp58 + _interp59 + _interp6 + _interp60 + _interp61 + _interp62 + _interp63 + _interp64 + _interp65 + _interp7 + _interp8 + _interp9 + cosl1p1 + cosl1p2 + k + l1 + p);
      // clang-format on
      _T _acc{};
      { // subkernel 1
        ...
        // clang-format off
        _acc += 0.001683501683501684 * fma(-1., _cse1 * _cse8 * _den11 * _den2 * _den5 * DiFfRG::za3_gpu::tr1(fenv) * _interp11 * _interp12 * _interp13, fma(-1., _cse1 * _cse8 * _den11 * _den2 * _den4 * DiFfRG::za3_gpu::tr2(fenv) * _interp12 * _interp16 * _interp17, fma(-1., _cse1 * _cse8 * _den2 * _den4 * _den6 * DiFfRG::za3_gpu::tr0(fenv) * _interp16 * _interp20 * _interp21, fma(-1., _cse1 * _cse15 * _den12 * _den3 * _den7 * DiFfRG::za3_gpu::tr8(fenv) * _interp25 * _interp26 * _interp27, fma(_cse1, _cse15 * _den12 * _den3 * _den7 * DiFfRG::za3_gpu::tr9(fenv) * _interp25 * _interp26 * _interp27, fma(-1., _cse1 * _cse15 * _den12 * _den3 * _den8 * DiFfRG::za3_gpu::tr10(fenv) * _interp26 * _interp34 * _interp35, fma(_cse1, _cse15 * _den12 * _den3 * _den8 * DiFfRG::za3_gpu::tr11(fenv) * _interp26 * _interp34 * _interp35, fma(_cse1, _cse15 * _den3 * _den7 * _den9 * DiFfRG::za3_gpu::tr6(fenv) * _interp25 * _interp37 * _interp38, fma(-1., _cse1 * _cse15 * _den3 * _den7 * _den9 * DiFfRG::za3_gpu::tr7(fenv) * _interp25 * _interp37 * _interp38, 0.)))))))));
        // clang-format on
      }
      { // subkernel 2
        const auto _den10 = powr<-2>(powr<2>(_interp48) + powr<2>(_interp44 * _interp45 + _interp49 * l1));
        const auto _cse1 = powr<-1>(l1);
        const auto _cse2 = powr<-2>(p);
        const auto _cse3 = -_cse1 * _interp43 * _interp44;
        const auto _cse4 = -_interp44;
        const auto _cse5 = _cse4 + _interp47;
        const auto _cse6 = 50. * _cse5;
        const auto _cse7 = _cse6 + _interp46;
        const auto _cse8 = -_cse1 * _cse7 * _interp45;
        const auto _cse9 = _cse3 + _cse8;
        const auto _cse10 = _interp1 * _interp2;
        // clang-format off
        _acc += fma(complex<double>(0.,-0.003367003367003367), _cse2 * _cse9 * _den10 * _den13 * _den16 * DiFfRG::za3_gpu::tr14(fenv) * _interp40 * _interp41 * _interp42, fma(complex<double>(0.,0.003367003367003367), _cse2 * _cse9 * _den10 * _den13 * _den16 * DiFfRG::za3_gpu::tr15(fenv) * _interp40 * _interp41 * _interp42, fma(complex<double>(0.,-0.003367003367003367), _cse2 * _cse9 * _den10 * _den14 * _den16 * DiFfRG::za3_gpu::tr16(fenv) * _interp41 * _interp56 * _interp57, fma(complex<double>(0.,0.003367003367003367), _cse2 * _cse9 * _den10 * _den14 * _den16 * DiFfRG::za3_gpu::tr17(fenv) * _interp41 * _interp56 * _interp57, fma(complex<double>(0.,0.003367003367003367), _cse2 * _cse9 * _den10 * _den13 * _den15 * DiFfRG::za3_gpu::tr12(fenv) * _interp40 * _interp61 * _interp62, fma(complex<double>(0.,-0.003367003367003367), _cse2 * _cse9 * _den10 * _den13 * _den15 * DiFfRG::za3_gpu::tr13(fenv) * _interp40 * _interp61 * _interp62, fma(-0.001683501683501684, _cse2 * _den2 * _den4 * DiFfRG::za3_gpu::tr3(fenv) * _interp16 * _interp22 * (_cse10 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(-0.001683501683501684, _cse2 * _den2 * _den5 * DiFfRG::za3_gpu::tr4(fenv) * _interp11 * _interp23 * (_cse10 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), fma(-0.001683501683501684, _cse2 * _den11 * _den2 * DiFfRG::za3_gpu::tr5(fenv) * _interp12 * _interp24 * (_cse10 + _interp3 * (_interp4 + 50. * _den1 * (-_interp2 + _interp5) * powr<6>(k))), 0.)))))))));
        // clang-format on
      }
      return _acc;
    }
