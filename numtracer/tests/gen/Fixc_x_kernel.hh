...
namespace numtracer_kernels
{
  class Fixc_x_kernel
  {
    ...
    static inline auto kernel(const double& p0, const double& p, const double& l0, const double& l1, const double& cos1)
    {
      ...
      double fenv[(numtracer_kernels::fixc_x::nenv) > 0 ? (numtracer_kernels::fixc_x::nenv) : 1];
      numtracer_kernels::fixc_x::fill(fenv, p0, p, l0, l1, cos1);  return numtracer_kernels::fixc_x::tr0(fenv);
    }
...
using numtracer_kernels::Fixc_x_kernel;